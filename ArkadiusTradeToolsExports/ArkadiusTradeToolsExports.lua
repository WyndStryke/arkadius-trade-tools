...
function ArkadiusTradeToolsExports:SetUpToolBar()
    ...
    self.frame.toolbar.TimeSelector.m_comboBox:AddItem({name = L["ATT_STR_30_DAYS"], callback = timeSelectorCallback, NewerThanTimeStamp = function() return ArkadiusTradeTools:GetStartOfDay(-30) end, OlderThanTimeStamp = function() return GetTimeStamp() end})
    self.frame.toolbar.TimeSelector.m_comboBox:AddItem({name = L["ATT_STR_ALL_TIME"], callback = timeSelectorCallback, NewerThanTimeStamp = function() return 0 end, OlderThanTimeStamp = function() return GetTimeStamp() end})
    self.frame.toolbar.TimeSelector.m_comboBox:AddItem({name = L["ATT_STR_THIS_MONTH"], callback = timeSelectorCallback, NewerThanTimeStamp = function() return ArkadiusTradeTools:GetStartOfMonth(0) end, OlderThanTimeStamp = function() return GetTimeStamp() end})
    self.frame.toolbar.TimeSelector.m_comboBox:AddItem({name = L["ATT_STR_LAST_MONTH"], callback = timeSelectorCallback, NewerThanTimeStamp = function() return ArkadiusTradeTools:GetStartOfMonth(-1) end, OlderThanTimeStamp = function() return ArkadiusTradeTools:GetStartOfMonth(0) end})
    self.frame.toolbar.TimeSelector.m_comboBox:AddItem({name = L["ATT_STR_PRIOR_MONTH"], callback = timeSelectorCallback, NewerThanTimeStamp = function() return ArkadiusTradeTools:GetStartOfMonth(-2) end, OlderThanTimeStamp = function() return ArkadiusTradeTools:GetStartOfMonth(-1) end})
