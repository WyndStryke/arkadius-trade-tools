local localization =
{
    ATT_STR_STATISTICS               = "Statistik",
    ATT_STR_NAME                     = "Name",
    ATT_STR_GUILD                    = "Gilde",
    ATT_STR_TOTAL                    = "Gesamt",
    ATT_STR_TAXES                    = "Steuern",
    ATT_STR_INTERNAL                 = "Intern",
    ATT_STR_ITEMCOUNT                = "# Gegenstände",
    ...
    ATT_STR_FILTER_TEXT_TOOLTIP      = "Textsuche nach User- oder Gildennamen",
